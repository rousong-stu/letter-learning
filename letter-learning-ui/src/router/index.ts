                ...
                children: [
                    {
                        ...
                        name: 'DefaultIcon',
                        component: () =>
                            import('@/views/vab/icon/defaultIcon.vue'),
                        meta: {
                            title: '默认图标',
                        },
                    },
                    {
                        ...
                        name: 'IconSelector',
                        component: () =>
                            import('@/views/vab/icon/iconSelector.vue'),
                        meta: {
                            title: '图标选择器',
                        },
                    },
                    {
                        ...
                        name: 'CustomSvg',
                        component: () =>
                            import('@/views/vab/icon/customSvg.vue'),
                        meta: {
                            title: '自定义图标',
                        },
                    },
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import('@/views/vab/table/inlineEditTable.vue'),
                        meta: {
                            title: '行内编辑表格',
                            noKeepAlive: true,
                        },
                    },
                    {
                        ...
                        name: 'CustomTable',
                        component: () =>
                            import('@/views/vab/table/customTable.vue'),
                        meta: {
                            title: '自定义表格',
                        },
                    },
                    {
                        ...
                        name: 'DynamicTable',
                        component: () =>
                            import('@/views/vab/table/dynamicTable.vue'),
                        meta: {
                            title: '动态表格',
                            badge: 'New',
                        },
                ...
                children: [
                    {
                        ...
                        name: 'WangEditor',
                        component: () =>
                            import('@/views/vab/editor/wangEditor.vue'),
                        meta: {
                            title: '腾讯文档',
                            guard: ['Admin'],
                            dot: true,
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import('@/views/vab/form/comprehensiveForm.vue'),
                        meta: {
                            title: '综合表单',
                        },
                    },
                    ...
                    },
                    {
                        ...
                        name: 'Checkbox',
                        component: () =>
                            import('@/views/vab/form/checkbox.vue'),
                        meta: {
                            title: '多选框',
                        },
                    },
                    ...
                    },
                    {
                        ...
                        name: 'InputNumber',
                        component: () =>
                            import('@/views/vab/form/inputNumber.vue'),
                        meta: {
                            title: '计数器',
                        },
                    },
                    ...
                    },
                    {
                        ...
                        name: 'TimePicker',
                        component: () =>
                            import('@/views/vab/form/timePicker.vue'),
                        meta: {
                            title: '时间选择器',
                        },
                    },
                    {
                        ...
                        name: 'DatePicker',
                        component: () =>
                            import('@/views/vab/form/datePicker.vue'),
                        meta: {
                            title: '日期选择器',
                        },
                    },
                    {
                        ...
                        name: 'DateTimePicker',
                        component: () =>
                            import('@/views/vab/form/dateTimePicker.vue'),
                        meta: {
                            title: '日期时间选择器',
                        },
                    },
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'DynamicAnchor',
                component: () =>
                    import('@/views/other/dynamicAnchor/index.vue'),
                meta: {
                    title: '动态锚点',
                    guard: ['Admin'],
                    icon: 'anchor-line',
                ...
                children: [
                    {
                        ...
                        name: 'Test1',
                        component: () =>
                            import('@/views/other/dynamicSegment/test1.vue'),
                        meta: {
                            hidden: true,
                            title: 'Params',
                            dynamicNewTab: true,
                    ...
                    },
                    {
                        ...
                        name: 'Test2',
                        component: () =>
                            import('@/views/other/dynamicSegment/test2.vue'),
                        meta: {
                            hidden: true,
                            title: 'Query',
                            dynamicNewTab: true,
                ...
                children: [
                    {
                        ...
                        name: 'DialogDrag',
                        component: () =>
                            import('@/views/other/drag/dialogDrag.vue'),
                        meta: {
                            title: '弹窗拖拽',
                            dot: true,
                        },
                    },
                    {
                        ...
                        name: 'CardDrag',
                        component: () =>
                            import('@/views/other/drag/cardDrag.vue'),
                        meta: {
                            title: '卡片拖拽',
                        },
                    },
                ...
                children: [
                    {
                        ...
                        name: 'IframeView',
                        component: () =>
                            import('@/views/other/iframe/view.vue'),
                        meta: {
                            hidden: true,
                            title: 'Iframe',
                            icon: 'window-line',
                    ...
                    },
                    {
                        ...
                        name: 'IframeSearch',
                        component: () =>
                            import('@/views/other/iframe/search.vue'),
                        meta: {
                            title: '自定义Iframe',
                            icon: 'search-2-line',
                        },
                ...
                children: [
                    {
                        ...
                        name: 'ExportExcel',
                        component: () =>
                            import('@/views/other/excel/exportExcel.vue'),
                        meta: {
                            title: '导出Excel',
                        },
                    },
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                '@/views/other/excel/exportMergeHeaderExcel.vue'
                            ),
                        meta: {
                            title: '导出合并Excel',
                        },
        ...
        children: [
            {
                ...
                name: 'DeleteColumn',
                component: () =>
                    import('@/views/noColumn/deleteColumn/index.vue'),
                meta: {
                    title: '无分栏',
                    icon: 'delete-column',
                    noColumn: true,
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'TaskManagement',
                component: () =>
                    import('@/views/setting/taskManagement/index.vue'),
                meta: {
                    title: '任务管理',
                    icon: 'task-line',
                    badge: 'New',
