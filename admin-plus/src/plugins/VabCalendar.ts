/** @type {*}
 * //github.com/jjonline/calendar.js/blob/master/calendar.js
 */
...
const VabCalendar: any = {
    ...
    getTerm(y: number, n: number) {
        ...
        const _info = [
            ...
            Number.parseInt(`0x${_table.slice(5, 5)}`).toString(),
            Number.parseInt(`0x${_table.slice(5, 10)}`).toString(),
            Number.parseInt(`0x${_table.slice(5, 15)}`).toString(),
            Number.parseInt(`0x${_table.slice(5, 20)}`).toString(),
            Number.parseInt(`0x${_table.slice(5, 25)}`).toString(),
        ]
        const _calcDay = [
            _info[0].slice(0, 1),
            _info[0].slice(1, 2),
     ...
     */
    solar2lunar(yPara: string, mPara: string, dPara: string) {
        let y: any = Number.parseInt(yPara)
        let m: any = Number.parseInt(mPara)
     ...
     */
    lunar2solar(y: any, m: any, d: any, isLeapMonth: boolean) {
        y = Number.parseInt(y)
        m = Number.parseInt(m)
        d = Number.parseInt(d)
